const mongoose = require('mongoose'); //Mongoose connection stuff.
const Product = require('./models/product');
const e = require('express');

mongoose.connect('mongodb://127.0.0.1:27017/farmStand', { useNewURLParser: true, useUnifiedTopology: true }) //Colt suggests this.
    .then(() => {
